...
import { Alternating } from "../components/Marketing/Features";
import { LargeAvatar } from "../components/Marketing/Testimonials";
              ...
              <div className='mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center'>
                <div className='lg:py-24'>
                  ...
                  <p className='mt-3 text-base text-white sm:mt-5 sm:text-xl lg:text-lg xl:text-xl'>
                    Using Shifter, create or migrate WordPress sites in minutes
                    that are scalable, secure from attacks, and 100% static with
                    no security or caching plugins required.
                  </p>
        ...
        <div className='relative bg-purple-800 py-4 sm:py-6 lg:py-16'>
          <div className='mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl'>
            ...
            <p className='mt-5 max-w-prose mx-auto text-xl text-white'>
              ...
              serverless hosting solution and static site generator for
              WordPress.
            </p>
            <div className='mt-12'>
              ...
              <blockquote className='mt-10'>
                <div className='max-w-3xl mx-auto text-center text-2xl leading-9 font-bold text-white'>
                  <p>
                    ...
                    all-in-one “serverless” architecture solutions that generate
                    static files from WordPress sites and serve them via
                    CDN.&rdquo;
                  </p>
                </div>
                ...
                <div className='relative lg:ml-10'>
                  ...
                  <blockquote className='relative'>
                    <div className='text-2xl leading-9 font-bold text-white'>
                      <p>
                        Thank you for introducing me to the #WordPress-centric
