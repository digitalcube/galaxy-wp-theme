    ...
    <div className='relative bg-purple-800 py-4 sm:py-6 lg:py-24'>
      <div className='mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl'>
        <div className='max-w-3xl mx-auto'>
          <h2 className='mt-2 font-bold text-white text-3xl sm:text-5xl'>
              ...
              <div key={feature.name} className='pt-6'>
                <div className='flow-root bg-white rounded-lg px-6 pb-8'>
                  <img
                    ...
                    aria-hidden='true'
                  />
                  <h3 className='mt-8 text-2xl font-bold text-purple-800'>
                    {feature.name}
                  </h3>
                  <p className='mt-5 text-base text-purple-800'>
